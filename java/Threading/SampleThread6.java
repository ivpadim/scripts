public class SampleThread6 implements Runnable {
    ...
    private void hacerRetiro(int cant) {
        System.out.println(Thread.currentThread().getName() + " intentando retiro");
        synchronized (this) { // Se puede sincronizar solo un bloque
